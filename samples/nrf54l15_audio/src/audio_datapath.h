...
#define CONFIG_AUDIO_MAX_PRES_DLY_US 100000
#define CONFIG_AUDIO_SAMPLE_RATE_HZ 16000
#define HEADSET 1
#define GATEWAY 2
#define CONFIG_AUDIO_DEV HEADSET
#define CONFIG_AUDIO_FRAME_DURATION_US 10000
#define CONFIG_BT_AUDIO_PRESENTATION_DELAY_US 100000
#define CONFIG_AUDIO_MIN_PRES_DLY_US 1000
