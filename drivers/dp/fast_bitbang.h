...
static ALWAYS_INLINE void pin_platform_config_input(void *base, uint32_t port, uint8_t pin)
{
...
static ALWAYS_INLINE void pin_platform_config_output(void *base, uint32_t port, uint8_t pin)
{
#if defined(CONFIG_SOC_SERIES_NRF52X) || defined(CONFIG_SOC_SERIES_NRF53X)
	NRF_GPIO_Type * reg = base;
